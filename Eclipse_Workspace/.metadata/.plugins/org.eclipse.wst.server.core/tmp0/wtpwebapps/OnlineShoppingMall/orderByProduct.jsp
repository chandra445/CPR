...
<html>
    ...
    <body>
        <form action="orderByProduct.do" method="post" name="multi">
     
        <div style="position: absolute; width: 535px; height: 54px; z-index: 1; left: 430px; top: 266px" id="layer1">
              <div align="center">
              <table border="0" width="72%" id="table1" height="98">
                  <tr>
                      <td height="43" width="127"><b>
                              Product Name :</b></td>
                      <td height="43">
                            <select size="1" name="prname" tabindex="1">
