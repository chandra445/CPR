...
<html>
    ...
    <body>
    <form action="updateProduct.do" method="post" name="multi" onsubmit="return validateProd()" >
         <div style="position: absolute; width: 535px; height: 54px; z-index: 1; left: 650px; top: 266px" id="layer1">
           ...
           <table border="0" width="72%" id="table1" height="98">
            ...
            <div style="position: absolute; width: 184px; height: 23px; z-index: 1; left: 650px; top: 450px" id="layer7">&nbsp; 
