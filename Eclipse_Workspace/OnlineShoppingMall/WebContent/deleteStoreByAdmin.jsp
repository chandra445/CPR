...
<html>
    ...
    <body>
        <form action="deleteStore.do" method="post" name="multi">
              ...
              <table border="0" width="72%" id="table1" height="98">
                  <tr>
                      <td height="43" width="127"><b>
                             Store manager user  Name :</b></td>
                      <td height="43">
                            <select size="1" name="strname" tabindex="1">
                               
                            <c:forEach var="list" items="${requestScope.storeList}">
								<option>${list.strname}</option>
							</c:forEach>
                            </select>
                      </td>
                  </tr>
