...
<!-- end header -->
<!-- start page -->
<div id="page" style="width: 940px; height: 603px">
	<!-- start content -->
	<div id="content">
		<div class="post">
	...
	<div id="sidebar">
		<ul>
			<li>
				<h2>Admin Login</h2>
				<ul>
					<li><a href="registerStoreByAdmin.jsp">Add Store Manager</a></li>
					<li><a href="registerCustomerByAdmin.jsp">Add Customer</a></li>
					<li ><a href="addAccountant.jsp">Add Accountant</a></li>
					<li><a href="getAccountants.do">Delete Accountant</a></li>
					<li><a href="getCustomers.do">Delete Customer</a></li>
...
<!-- start footer -->
<div id="footer">
		<p>©2016 All Rights Reserved. &nbsp;&nbsp; Design by Chandra babu Jonnakuti</p>
</div>
<!-- end footer -->
</body>
</html>