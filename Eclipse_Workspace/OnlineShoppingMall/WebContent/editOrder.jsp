...
<html>
    <head>
        ...
        <script>
            function validate()
            {
               ...
               {
               alert("Please refresh your page to get changes..");
                self.close();
                 return true;
               }
            }
    ...
    <body background="images/img02.png">
         <form name="multi" action="addToCart1.jsp" onsubmit="return validate()" method="post">
            <table>
                <%!
                ...
                reqqty=Integer.parseInt(request.getParameter("reqty"));
