...
<html>
    ...
    <body>
        <form action="deleteCustomer.do" method="post" name="multi">
              ...
              <table border="0" width="72%" id="table1" height="98">
                  <tr>
                      <td height="43" width="127"><b>
                             Customer User  Name :</b></td>
                      <td height="43">
                            <select size="1" name="uname" tabindex="1">
                               
                            <c:forEach var="list" items="${requestScope.genericList}">
								<option>${list.uname}</option>
							</c:forEach>
                            </select>
                      </td>
                  </tr>
